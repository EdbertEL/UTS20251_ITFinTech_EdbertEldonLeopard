        ...
        <div className="rounded-lg bg-white p-8 shadow-lg">
          {loginStep === 'credentials' ? (
            <form className="space-y-6" onSubmit={handleSendOtp}>
              ...
              <div>
                <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Send Code</button>
              </div>
            </form>
          ) : (
